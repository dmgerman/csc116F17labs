...
* Lab exercises
As usual, code files and automated tests have been provided at [[https://github.com/dmgerman/csc116/blob/master/tutorials/files/lab09-files.zip][https://github.com/dmgerman/csc116/blob/master/tutorials/files/lab09-files.zip]]. For this lab, there is only one tester, but several independent programs, each containing a task to implement.
